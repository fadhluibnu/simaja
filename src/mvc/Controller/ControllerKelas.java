...
public class ControllerKelas {
    ...
    // walikelasList tidak lagi diperlukan karena kita akan memparse langsung dari ComboBox
    ...
    public void isiField(int row){
        ...
        frame.getKodekelas().setText(lkelas.get(row).getKelasId().toString());
        ...
        String nipWaliKelasDariTabel = lkelas.get(row).getNipWaliKelas();
        boolean found = false;
        for (Guru guru : lGuru) {
            if (guru.getNip().equals(nipWaliKelasDariTabel)) {
                frame.getNipWaliKelas().setSelectedItem(formatGuruForComboBox(guru));
                found = true;
                break;
            }
        }
    ...
    public void insert(String NipWaliKelas){
        ...
        {
            Kelas b = new Kelas();
            b.setKelasId(frame.getKodekelas().getText());
