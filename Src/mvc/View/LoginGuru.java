...
public class LoginGuru extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        ControllerGuru controller = new ControllerGuru(null);
        Guru guru = controller.login(username, password);
        
        if (guru != null) {
            // Authentication successful
            // Check if account is active
            if (!"Aktif".equalsIgnoreCase(guru.getIsActive())) {
                JOptionPane.showMessageDialog(this, "Akun guru tidak aktif!", "Login Gagal", JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            // Open UserGuru and pass guru NIP and name
                UserGuru userGuru = new UserGuru(guru.getNip(), guru.getNama());
                userGuru.setVisible(true);
                this.dispose();
                
                JOptionPane.showMessageDialog(null, "Login berhasil. Selamat datang, " + guru.getNama() + "!");
            } else {
