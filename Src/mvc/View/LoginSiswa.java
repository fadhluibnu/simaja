...
public class LoginSiswa extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        ControllerSiswa controller = new ControllerSiswa(null);
        Siswa siswa = controller.login(username, password);
        
        if (siswa != null) {
            // Authentication successful
            // Check if account is active
            if (!"Aktif".equalsIgnoreCase(siswa.getIsActive())) {
                JOptionPane.showMessageDialog(this, "Akun siswa tidak aktif!", "Login Gagal", JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            // Open UserSiswa and pass siswa NIS, nama, and kelasId
                UserSiswa userSiswa = new UserSiswa(siswa.getNis(), siswa.getNama(), siswa.getKelasId());
                userSiswa.setVisible(true);
                this.dispose();
                
                JOptionPane.showMessageDialog(null, "Login berhasil. Selamat datang, " + siswa.getNama() + "!");
//                UserSiswa usersSiswa = new UserSiswa(siswa.getNis(), siswa.getNama(), siswa.getKelasId());
//                usersSiswa.setVisible(true);
//                this.dispose();
